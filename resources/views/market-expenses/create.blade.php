...
@section('title', 'Add Expense — Mess App')

@section('content')
    <div class="mx-auto max-w-lg">
        <h1 class="text-2xl font-bold tracking-tight text-slate-900">Add market expense</h1>
        <p class="mt-1 text-sm text-slate-500">Record a purchase for the mess.</p>

        @if ($users->isEmpty())
            <div class="form-callout">
                Add at least one user before recording an expense.
        ...
        <form action="{{ route('expenses.store') }}" method="post" class="form-card" novalidate>
            @csrf
            <div>
            ...
            <div>
                ...
                <input type="number" name="amount" id="amount" value="{{ old('amount') }}" step="0.01" min="0" required inputmode="decimal"
            ...
            <div class="form-actions">
                <button type="submit" @disabled($users->isEmpty()) class="form-btn-primary">Save expense</button>
