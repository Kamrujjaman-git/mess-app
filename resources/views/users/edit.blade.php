...
@section('title', 'Edit User — Mess App')

@section('content')
    <div class="mx-auto max-w-lg">
        <h1 class="text-2xl font-bold tracking-tight text-slate-900">Edit user</h1>
        <p class="mt-1 text-sm text-slate-500">Change name, email, or role for this member.</p>
        ...
        <form action="{{ route('users.update', $user) }}" method="post" class="form-card" novalidate>
            ...
            <div>
                ...
                <input type="text" name="name" id="name" value="{{ old('name', $user->name) }}" required maxlength="255" autocomplete="name"
            ...
            <div>
                ...
                <select name="role" id="role" required
                    ...
                    <option value="" disabled {{ old('role', $user->role) ? '' : 'selected' }}>Choose role…</option>
