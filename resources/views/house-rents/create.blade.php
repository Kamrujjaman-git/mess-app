...
@section('content')
    <div class="mx-auto max-w-lg">
        ...
        <p class="mt-1 text-sm text-slate-500">Record rent for a member. Month uses <code class="rounded bg-slate-100 px-1.5 py-0.5 text-xs font-medium text-slate-700">Y-m</code> format.</p>
        ...
        <form action="{{ route('house-rents.store') }}" method="post" class="form-card" novalidate>
            ...
            <div class="form-actions">
                ...
                <a href="{{ route('house-rents.index', ['month' => old('month', request('month', date('Y-m')))]) }}"
